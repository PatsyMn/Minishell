...
/*   Updated: 2025/10/01 13:55:06 by mbores           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../minishell.h"

static int execute_builtin_2(t_command *command, t_export *export)
{
...
{
    if (pipex->pipe || !command->args || !command->args[0])
        return (-1);
    ...
    //     return (1);
        ...
        return (execute_builtin_2(command, export));
}
